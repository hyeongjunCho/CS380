...
void quad4(Model &model, int a, int b, int c, int d, int num)
{
	...
	if (num == 0)
	{
		//model.add_texcoord(glm::vec2(1.0 / 3.0, 1.0 / 4.0));
		//model.add_texcoord(glm::vec2(1.0 / 3.0, 1.0 / 2.0));
		//model.add_texcoord(glm::vec2(0.0, 1.0 / 2.0));
		model.add_texcoord(glm::vec2(1.0 / 2.0, 1.0 / 3.0));
		model.add_texcoord(glm::vec2(1.0 / 4.0, 1.0 / 3.0));
		model.add_texcoord(glm::vec2(1.0 / 4.0, 0.0));
	}
	else if (num == 5)
	{
		model.add_texcoord(glm::vec2(1.0 / 2.0, 1.0));
		model.add_texcoord(glm::vec2(1.0 / 4.0, 1.0));
		model.add_texcoord(glm::vec2(1.0 / 4.0, 2.0 / 3.0));
	}
	else
	{
		model.add_texcoord(glm::vec2((float)(num - 1) / 4.0, 2.0 / 3.0));
		model.add_texcoord(glm::vec2((float)(num - 1) / 4.0, 1.0 / 3.0));
		model.add_texcoord(glm::vec2((float)(num) / 4.0, 1.0 / 3.0));
	}
	...
	if (num == 0)
	{
		model.add_texcoord(glm::vec2(1.0 / 2.0, 1.0 / 3.0));
		model.add_texcoord(glm::vec2(1.0 / 4.0, 0.0));
		model.add_texcoord(glm::vec2(1.0 / 2.0, 0.0));
	}
	else if (num == 5)
	{
		model.add_texcoord(glm::vec2(1.0 / 2.0, 1.0));
		model.add_texcoord(glm::vec2(1.0 / 4.0, 2.0 / 3.0));
		model.add_texcoord(glm::vec2(1.0 / 2.0, 2.0 / 3.0));
	}
	else
	{
		model.add_texcoord(glm::vec2((float)(num - 1) / 4.0, 2.0 / 3.0));
		model.add_texcoord(glm::vec2((float)(num) / 4.0, 1.0 / 3.0));
		model.add_texcoord(glm::vec2((float)(num) / 4.0, 2.0 / 3.0));
	}
...
void init_texture_cube(Model &model){
	...
	quad4(model, 1, 0, 3, 2, 2);
	quad4(model, 2, 3, 7, 6, 3);
	quad4(model, 3, 0, 4, 7, 0);
	quad4(model, 6, 5, 1, 2, 5);
	quad4(model, 6, 7, 4, 5, 4);
	quad4(model, 5, 4, 0, 1, 1);
}
